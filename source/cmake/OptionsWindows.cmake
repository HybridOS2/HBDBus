...
set(HBDBus_FRAMEWORK_HEADERS_DIR ${CMAKE_BINARY_DIR}/HBDBus/Headers)
set(HBDBus_PRIVATE_FRAMEWORK_HEADERS_DIR ${CMAKE_BINARY_DIR}/HBDBus/PrivateHeaders)

# Override derived sources directories
set(WTF_DERIVED_SOURCES_DIR ${CMAKE_BINARY_DIR}/WTF/DerivedSources)
set(HBDBus_DERIVED_SOURCES_DIR ${CMAKE_BINARY_DIR}/HBDBus/DerivedSources)

# Override library types
set(HBDBus_LIBRARY_TYPE OBJECT)
set(HBDBusTestSupport_LIBRARY_TYPE OBJECT)
